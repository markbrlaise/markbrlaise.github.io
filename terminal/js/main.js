...
var main = (function () {
    ...
    var configs = (function () {
        ...
        Singleton.defaultOptions = {
            ...
            welcome: "Mark_Kiguli, the minimalist welcomes you, I love the terminal because it gets the work done efficiently.\n\nRun 'help' command, to get started.\n\nCommand autocomplete with 'TAB' works too, feel free xD",
    ...
    var files = (function () {
        ...
        Singleton.defaultOptions = {
            "about.txt": "Hola, I am mark_kiguli.\n\nA backend python developer\n\nI am a python backend software developer. I work with the django framework and I have built several projects with it. I can work with both start-ups and large companies ready to scale. I am a team player and I enjoy working on group projects.\n\nI have the following skills:\n--\x3e Python Programming\n--\x3e Linux\n--\x3e Django Restframework\n--\x3e C & C++ Programming\n--\x3e Code Review\n--\x3e Git - Version Control\n--\x3e DevOps and Automation\n--\x3e Contributing to Open Source Software (OSS)\n--\x3e Arduino and raspberry pi",
            "interests.txt": "Interests:\n--\x3e Playing soccer(Pedri regen)\n--\x3e Walking on the shores\n--\x3e Playing games (FIFA at times)\n--\x3e Hackathons\n--\x3e Eating good healthy food\n--\x3e Awesome Technology\n--\x3e Travelling\n--\x3e Intellectual conversations about stoicism\n--\x3e DIY stuff"
        };
        return {
            getInstance: function (options) {
                instance === void 0 && (instance = new Singleton(options));
